...
export class App extends Component {
    ...
    <div class="flex-1 flex justify-between items-center">
      <a href="/">
      <Tilt className="Tilt pt-2 shadow-sm border-sm" options={{ max : 25 }} style={{ height: 150, width: 150 }} >
 <div className="Tilt-inner"> <img width="150" height="50" src="https://m.media-amazon.com/images/S/abs-image-upload-na/4/AmazonStores/ATVPDKIKX0DER/dbfec712aef73fdc2395fefba80cb9d3.w600.h600.jpg" alt="Logo"/> </div>
</Tilt>
    </a>
  </div>
    ...
    columns={[
      {
        ...
        title: 'CWC',
        url: 'https://github.com/AquamanRanda/AS121_Code-Geass',
