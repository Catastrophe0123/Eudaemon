...
export class Guardian extends Component {
	...
	formatData = () => {
		...
		if (Object.keys(this.state.data).includes('photo')) {
			x.push(<div className="text-center"><img src={this.state.data['photo']} /> </div>);
		} else {
			x.push(
                <div className="flex pt-4 pb-4 justify-center text-center">
				<img 
					src={
		...
		return <div className="pb-4 ">{x}</div>;
	};
	...
	render() {
		...
		return (
            <div className="pt-20">
			<div className="pt-10 bg-blue-300 pb-10 border-4 border-black text-center">
				<strong><h1>show guardian data</h1></strong>    
